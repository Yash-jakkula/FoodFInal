...
export default function WebFooter(){
    ...
    <div class="col mb-3">
      ...
      <ul class="nav flex-column">
        ...
        <li class="nav-item mb-2"><a href="#" class="nav-link w-text-white p-0 heading">icube.help@gmail.com</a></li>
        </div>
        <div className="d-flex flex-direction-row align-items-center mb-2">
        <img src="/p.png" className="footer-icon"/>
        <li class="nav-item mb-2"><a href="#" class="nav-link w-text-white p-0 heading">+91 9876543210</a></li>
        </div>
